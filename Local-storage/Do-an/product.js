var products = [{
    ...
    img: 'https://hrv.com.vn/wp-content/uploads/2021/03/ao-dai-truyen-thong-phu-nu-viet-nam-net-dep-van-hoa-viet-b4e71c5594bdce1126e6fbc61b7dae75.jpg',
    price: 122000,
},
{
    id: 'SP2',
...
var listproduct = '<div class="col-lg-3 col-md-6 col-sm-6 col-6 mt-3">';
    ...
    listproduct += '</a>';
    listproduct += '</span>';
    listproduct += '<button onclick="detail()">'+ "Detail" + "</button>";
    listproduct += '</div>';
    listproduct += '</div>';
